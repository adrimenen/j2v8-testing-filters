...
public class FilterTemperatureV5 {
	...
	private static HashMap<String, Object> filterTemperature(HashMap<String, Object> state, Object value) throws FileNotFoundException {
		...
		V8Array datastreamsChanged = runtime.executeArrayScript(readFile("filterTemperatureV5.js"));
		...
		for (int i = 0; i < datastreamsChanged.length(); i++) {
			String ds = (String) datastreamsChanged.get(i);
			state.put(ds, m.get(ds));
		}
